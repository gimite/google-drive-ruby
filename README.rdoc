...
Example to read/write files in Google Drive:
  ...
  # first time and save it to ruby_google_drive.token file for later usages.
  #
  ...
  session = GoogleDrive.saved_session("./.ruby_google_drive.token", nil, CLIENT_ID, CLIENT_SECRET)

  # or create .ruby_google_drive.token file which contains the generated client ID and client secret, which looks like this:
  ...
  # }
  # and then
  session = GoogleDrive.saved_session("./.ruby_google_drive.token")

  # where first argument is a path to your config file with credentials.
