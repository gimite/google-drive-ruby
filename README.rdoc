...
First, follow "Create a client ID and client secret" in {this page}[https://developers.google.com/drive/web/auth/web-server] to get a 'installed application' client ID and client secret for OAuth.
