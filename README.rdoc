...
Example to read/write files in Google Drive, the method "saved_session" will prompt the credential via command line for the first time and save it for later usages:
